...
# Callback of the ROS subscriber. 
    ...
    def __init__(self, camera_name):
        ...
        left_file_name  = rospy.get_param('~left_file_name',  rospack.get_path('ps4eye')+'/camera_info/left_small.yaml')
        right_file_name = rospy.get_param('~right_file_name', rospack.get_path('ps4eye')+'/camera_info/right_small.yaml')
